...
<main class="posts">
	...
	<header class="post_header">
		<h3 class="post_title"><a href="<?php echo $this->url->get('post/show/'); ?><?php echo $post->post_title; ?>"><?php echo $post->post_title; ?></a></h3>
		<span class="post_details"><small><?php echo $post->post_author; ?> - <?php echo $post->created_at; ?></small></span>
		<h5 class="post_desc"><?php echo $post->post_desc; ?></h5>
	</header>
	...
	<p>Made with Phalcon v<?php echo Phalcon\Version::get(); ?></p>
</footer>
